...
<script>
var _eventHandlers = {}; // contient tous les eventlistener
...
<html>
    ...
    <body onload="dessineStatParLieu()">
        <div class="bandeau">
            <h1> Recette & Dépense </h1>
        </div>
        
        <div class="menu">
            <ul class="nav">
                <li> <a href="PrgFest.php">Index</a> </li>
...
function dessineStatParRepresentation(){
		...
		ctx.font = "24px Arial";
		ctx.fillStyle = "black";
		ctx.fillText("Recette & Dépense par Compagnie", 400 ,40);
		...
		$.ajax({
			...
			for(let i = 0; i < RectPath2D.length;i++){
			    ...
			    addEvent(c,'mousemove',function(event){
       		    ...
       		    <button onclick="dessineStatParLieu()">Par Lieu</button><button onclick="dessineStatParRepresentation()">Par Compagnie</button>
                <canvas id="Stat" width="1250" height="700"></canvas> 
                <canvas id="StatInfo" width="1200" height="600"></canvas>       		
